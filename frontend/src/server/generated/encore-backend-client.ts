// Code generated by the Encore v1.46.10 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-yatma-backend-ukh2.encr.app`
}
...
/**
 * Client is an API client for the yatma-backend-ukh2 Encore application.
 */
...
export namespace boards {
    ...
    export interface CreateManyBoardsRequest {
    ...
    export class ServiceClient {
        ...
        public async create(params: CreateBoardRequest): Promise<BoardResponse> {
        ...
        public async update(id: string, params: UpdateBoardRequest): Promise<BoardResponse> {
            // Now make the actual call to the API
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "yatma-backend-ukh2-Generated-TS-Client (Encore/v1.46.10)";
        }
